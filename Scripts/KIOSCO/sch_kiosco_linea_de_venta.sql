...
CREATE TABLE `linea_de_venta` (
  `LINEA_ID` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `linea_de_venta_ibfk_1` FOREIGN KEY (`VENTA_ID`) REFERENCES `venta` (`VENTA_ID`),
  CONSTRAINT `linea_de_venta_ibfk_2` FOREIGN KEY (`PRODUCT_ID`) REFERENCES `product` (`PRODUCT_ID`)
...
-- Dump completed on 2019-05-06 16:00:42
